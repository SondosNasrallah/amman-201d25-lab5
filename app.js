...
function sum(a, b) { //eslint-disable-line
    let theResult = a + b;
      return [theResult, `The sum of ${a} and ${b} is ${theResult}.`];
...
// Write your code here
  function multiplyArray(multArr) { //eslint-disable-line
    ...
    let mA = multiply(multArr[0], multiply(multArr[1], multArr[2])[0])[0];

    return [mA, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${mA}.`]
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  function multiplyAnyArray(dynamicArray) { //eslint-disable-line
      ...
      for (let i = 0; i < dynamicArray.length; i++) {
         ...
         multiPle= multiply(multiPle, dynamicArray[i])[0];
  
      }
      return [multiPle `The numbers 1,2,3,4,5 have a product of 120.`]
  }
